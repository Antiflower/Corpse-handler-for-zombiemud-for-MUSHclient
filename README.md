...
totem: uses the death knight skill vile totem at a corpse(if a totem exists in the room the script will default to the tin command to destroy the corpse, this requires a tinning kit, but you do not need to train tinning to tin, only train tinning if you want to actually get cans to eat from the corpse)
